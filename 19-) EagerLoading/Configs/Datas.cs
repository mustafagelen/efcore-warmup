...
namespace _19___EagerLoading.Configs;
public class EmployeeData : IEntityTypeConfiguration<Employee>
{
    public void Configure(EntityTypeBuilder<Employee> builder)
    {
        ...
        {
                new(){ Id = 1, RegionId = 1, Name = "Mustafa", Surname = "Gelen", Salary = 1500},
                new(){ Id = 2, RegionId = 2, Name = "Yusuf", Surname = "Gelen", Salary = 1500},
                new(){ Id = 3, RegionId = 1, Name = "Ahmet", Surname = "Gelen", Salary = 1500},
                new(){ Id = 4, RegionId = 2, Name = "Meymet", Surname = "Gelen", Salary = 1500},
        });
    }
}
...
public class RegionData : IEntityTypeConfiguration<Region>
{
    public void Configure(EntityTypeBuilder<Region> builder)
    {
        ...
        {
              new(){ Id = 1, Name = "Eruzum" },
              new(){ Id = 2, Name = "İstanbul" }
        });
    }
}